...
describe("MemObj", function() {
  ...
  for(var i=0;i<devices.length;i++) {
    console.log(cl.getDeviceInfo(devices[i],cl.DEVICE_VENDOR)+" "+cl.getDeviceInfo(devices[i],cl.DEVICE_NAME));
  ...
  context = cl.createContext(properties, devices, null, null);
